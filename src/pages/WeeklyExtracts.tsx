...
const extractConfigs: ExtractConfig[] = [
  ...
  },
  {
    ...
    mapRow: (r) => [
      pickValue(r, ["uid", "vca_id", "id", "child_id"]),
      pickValue(r, ["household_id", "hhid", "hh_id"]),
      pickValue(r, ["vca_gender", "gender"]),
      pickValue(r, ["age"]),
      pickValue(r, ["hiv_status", "vca_hiv_status", "hivstatus"]),
      pickValue(r, ["facility", "facility_name"]),
      pickValue(r, ["district", "district_name"]),
      pickValue(r, ["ward", "ward_name"]),
      pickValue(r, ["last_service_date", "lastServiceDate"]),
    ],
  },
  {
    key: "vca-services",
  ...
  },
  {
    ...
    headers: [
      "household_id", "vca_id", "flag_type", "severity",
      "description", "status", "date_flagged",
    ],
    mapRow: (r) => [
      pickValue(r, ["household_id", "hhid"]),
      pickValue(r, ["vca_id", "child_id"]),
      pickValue(r, ["flag_type", "type"]),
      pickValue(r, ["severity", "priority"]),
      pickValue(r, ["description", "notes", "comment"]),
      pickValue(r, ["status", "state"]),
      pickValue(r, ["date_flagged", "created_at"]),
    ],
  },
];
